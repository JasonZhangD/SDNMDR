...
"""
This sample application performs as SDNMDR for EVPN VXLAN and constructs
...
class RestSdnmdr(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _CONTEXTS = {'wsgi': WSGIApplication}

    def __init__(self, *args, **kwargs):
        super(RestSdnmdr, self).__init__(*args, **kwargs)
        wsgi = kwargs['wsgi']
        wsgi.register(RestSdnmdrController, {RestSdnmdr.__name__: self})
...
class RestSdnmdrController(ControllerBase):

    def __init__(self, req, link, data, **config):
        super(RestSdnmdrController, self).__init__(req, link, data, **config)
        self.sdnmdr_app = data[RestSdnmdr.__name__]
    ...
    def add_speaker(self, **kwargs):
        ...
        Example::
            ...
            $ curl -X POST -d '{
             ...
             "as_number": 65000,
             "router_id": "172.17.0.1"
             }' http://localhost:8080/sdnmdr/speakers | python -m json.tool
    ...
    def get_speakers(self, **kwargs):
        ...
        Example::
            ...
            $ curl -X GET http://localhost:8080/sdnmdr/speakers |
             python -m json.tool
    ...
    @route(API_NAME, '/sdnmdr/speakers', methods=['DELETE'])
    @delete_method()
    def del_speaker(self, **kwargs):
        ...
        Usage:
            ...
            Method  URI
            ======= ================
            DELETE  /sdnmdr/speakers
            ======= ================

        Example::

            $ curl -X DELETE http://localhost:8080/sdnmdr/speakers |
             python -m json.tool
        ...
        """
        try:
            body = self.sdnmdr_app.del_speaker()
        except BGPSpeakerNotFound as e:
            return e.to_response(status=404)
    ...
    def add_neighbor(self, **kwargs):
        ...
        Example::
            ...
            $ curl -X POST -d '{
             "address": "172.17.0.2",
             "remote_as": 65000
             }' http://localhost:8080/sdnmdr/neighbors |
             python -m json.tool
    ...
    def get_neighbors(self, **kwargs):
        ...
        Usage:
            ...
            Method  URI
            ======= ========================
            GET     /sdnmdr/neighbors
            ======= ========================

        Example::

            $ curl -X GET http://localhost:8080/sdnmdr/neighbors |
             python -m json.tool
    ...
    def get_neighbor(self, **kwargs):
        ...
        Example::
            ...
            $ curl -X GET http://localhost:8080/sdnmdr/neighbors/172.17.0.2 |
             python -m json.tool
    ...
    @route(API_NAME, '/sdnmdr/neighbors/{address}', methods=['DELETE'])
    @delete_method(
        keywords={
            "address": str,
        })
    def del_neighbor(self, **kwargs):
        ...
        Usage:
            ...
            Method  URI
            ======= ==================================
            DELETE  /sdnmdr/speaker/neighbors/{address}
            ======= ==================================
        ...
        Example::
            ...
            $ curl -X DELETE http://localhost:8080/sdnmdr/speaker/neighbors/172.17.0.2 |
             python -m json.tool
        ...
        """
        try:
            body = self.sdnmdr_app.del_neighbor(**kwargs)
        except (BGPSpeakerNotFound, NeighborNotFound) as e:
            return e.to_response(status=404)
    ...
    @route(API_NAME, '/sdnmdr/networks', methods=['POST'])
    @post_method(
        keywords={
            "vni": to_int,
        })
    def add_network(self, **kwargs):
        ...
        Example::
            ...
            $ curl -X POST -d '{
             "vni": 10
             }' http://localhost:8080/sdnmdr/networks | python -m json.tool
        ...
        """
        try:
            body = self.sdnmdr_app.add_network(**kwargs)
        except BGPSpeakerNotFound as e:
            return e.to_response(status=404)
    ...
    def _get_networks(self, **kwargs):
        try:
            body = self.sdnmdr_app.get_networks(**kwargs)
    ...
    @route(API_NAME, '/sdnmdr/networks', methods=['GET'])
    @get_method()
    def get_networks(self, **kwargs):
        ...
        Example::
            ...
            $ curl -X GET http://localhost:8080/sdnmdr/networks |
             python -m json.tool
    ...
    @route(API_NAME, '/sdnmdr/networks/{vni}', methods=['GET'])
    @get_method(
        keywords={
            "vni": to_int,
        })
    def get_network(self, **kwargs):
        ...
        Example::
            ...
            $ curl -X GET http://localhost:8080/sdnmdr/networks/10 |
             python -m json.tool
    ...
    @route(API_NAME, '/sdnmdr/networks/{vni}', methods=['DELETE'])
    @delete_method(
        keywords={
            "vni": to_int,
        })
    def del_network(self, **kwargs):
        ...
        Example::
            ...
            $ curl -X DELETE http://localhost:8080/sdnmdr/networks/10 |
             python -m json.tool
        ...
        """
        try:
            body = self.sdnmdr_app.del_network(**kwargs)
    ...
    @route(API_NAME, '/sdnmdr/networks/{vni}/clients', methods=['POST'])
    @post_method(
        keywords={
            "vni": to_int,
            "port": str,
    ...
    def add_client(self, **kwargs):
        ...
        Usage:
            ...
            Method  URI
            ======= =============================
            POST    /sdnmdr/networks/{vni}/clients
            ======= =============================
        ...
        Example::
            ...
            $ curl -X POST -d '{
             ...
             "mac": "aa:bb:cc:dd:ee:ff",
             "ip": "10.0.0.1"
             }' http://localhost:8080/sdnmdr/networks/10/clients |
             python -m json.tool
        ...
        """
        try:
            body = self.sdnmdr_app.add_client(**kwargs)
    ...
    @route(API_NAME, '/sdnmdr/networks/{vni}/clients/{mac}', methods=['DELETE'])
    @delete_method(
        keywords={
            "vni": to_int,
            "mac": str,
    ...
    def del_client(self, **kwargs):
        ...
        Usage:
            ...
            Method  URI
            ======= ===================================
            DELETE  /sdnmdr/networks/{vni}/clients/{mac}
            ======= ===================================
        ...
        Example::
            ...
            $ curl -X DELETE http://localhost:8080/sdnmdr/networks/10/clients/aa:bb:cc:dd:ee:ff |
             python -m json.tool
        ...
        """
        try:
            body = self.sdnmdr_app.del_client(**kwargs)
        except (BGPSpeakerNotFound, DatapathNotFound,
